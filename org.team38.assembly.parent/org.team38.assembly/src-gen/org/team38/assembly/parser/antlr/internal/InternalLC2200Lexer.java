...
public class InternalLC2200Lexer extends Lexer {
    ...
    public final void mRULE_OOP() throws RecognitionException {
        try {
            int _type = RULE_OOP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:1487:10: ( ( 'halt' | 'ei' | 'di' | 'reti' ) )
            // InternalLC2200.g:1487:12: ( 'halt' | 'ei' | 'di' | 'reti' )
            {
            // InternalLC2200.g:1487:12: ( 'halt' | 'ei' | 'di' | 'reti' )
            int alt2=4;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_JOP() throws RecognitionException {
        try {
            int _type = RULE_JOP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:1491:10: ( 'jalr' )
            // InternalLC2200.g:1491:12: 'jalr'
            {
            match("jalr"); 
    ...
    public final void mRULE_ROP() throws RecognitionException {
        try {
            int _type = RULE_ROP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:1493:10: ( ( 'add' | 'nand' ) )
            // InternalLC2200.g:1493:12: ( 'add' | 'nand' )
            {
            // InternalLC2200.g:1493:12: ( 'add' | 'nand' )
            int alt3=2;
    ...
    public final void mRULE_IOP_OFFSET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:1497:17: ( ( 'lw' | 'sw' ) )
            // InternalLC2200.g:1497:19: ( 'lw' | 'sw' )
            {
            // InternalLC2200.g:1497:19: ( 'lw' | 'sw' )
            int alt4=2;
    ...
    public final void mRULE_NEWLINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:1509:14: ( ( EOF | ( '\\r' )? '\\n' ) )
            // InternalLC2200.g:1509:16: ( EOF | ( '\\r' )? '\\n' )
            {
            // InternalLC2200.g:1509:16: ( EOF | ( '\\r' )? '\\n' )
            int alt7=2;
