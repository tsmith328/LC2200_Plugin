...
public class InternalLC2200Lexer extends Lexer {
    ...
    public final void mRULE_OOP() throws RecognitionException {
        try {
            int _type = RULE_OOP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2773:10: ( ( 'halt' | 'ei' | 'di' | 'reti' | 'bono' ) )
            // InternalLC2200.g:2773:12: ( 'halt' | 'ei' | 'di' | 'reti' | 'bono' )
            {
            // InternalLC2200.g:2773:12: ( 'halt' | 'ei' | 'di' | 'reti' | 'bono' )
            int alt2=5;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_JOP() throws RecognitionException {
        try {
            ...
            // InternalLC2200.g:2777:10: ( ( 'jalr' | 'bonj' ) )
            // InternalLC2200.g:2777:12: ( 'jalr' | 'bonj' )
    ...
    public final void mRULE_ROP() throws RecognitionException {
        try {
            ...
            // InternalLC2200.g:2779:10: ( ( 'add' | 'nand' | 'bonr' ) )
            // InternalLC2200.g:2779:12: ( 'add' | 'nand' | 'bonr' )
            {
            // InternalLC2200.g:2779:12: ( 'add' | 'nand' | 'bonr' )
            int alt4=3;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_IOP_OFFSET() throws RecognitionException {
        try {
            ...
            // InternalLC2200.g:2783:17: ( ( 'lw' | 'sw' | 'boni' ) )
            // InternalLC2200.g:2783:19: ( 'lw' | 'sw' | 'boni' )
            {
            // InternalLC2200.g:2783:19: ( 'lw' | 'sw' | 'boni' )
            int alt5=3;
            switch ( input.LA(1) ) {
