...
public class InternalLC2200Lexer extends Lexer {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            ...
            // InternalLC2200.g:2767:9: ( ( ' ' | '\\t' )+ )
            // InternalLC2200.g:2767:11: ( ' ' | '\\t' )+
            {
            // InternalLC2200.g:2767:11: ( ' ' | '\\t' )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_LA() throws RecognitionException {
        try {
            int _type = RULE_LA;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2769:9: ( 'la' )
            // InternalLC2200.g:2769:11: 'la'
            {
            match("la"); 
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2771:11: ( '.word' )
            // InternalLC2200.g:2771:13: '.word'
            {
            match(".word"); 
    ...
    public final void mRULE_OOP() throws RecognitionException {
        try {
            int _type = RULE_OOP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2773:10: ( ( 'halt' | 'ei' | 'di' | 'reti' ) )
            // InternalLC2200.g:2773:12: ( 'halt' | 'ei' | 'di' | 'reti' )
            {
            // InternalLC2200.g:2773:12: ( 'halt' | 'ei' | 'di' | 'reti' )
            int alt2=4;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_NOOP() throws RecognitionException {
        try {
            int _type = RULE_NOOP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2775:11: ( 'noop' )
            // InternalLC2200.g:2775:13: 'noop'
            {
            match("noop"); 
    ...
    public final void mRULE_JOP() throws RecognitionException {
        try {
            int _type = RULE_JOP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2777:10: ( 'jalr' )
            // InternalLC2200.g:2777:12: 'jalr'
            {
            match("jalr"); 
    ...
    public final void mRULE_ROP() throws RecognitionException {
        try {
            int _type = RULE_ROP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2779:10: ( ( 'add' | 'nand' ) )
            // InternalLC2200.g:2779:12: ( 'add' | 'nand' )
            {
            // InternalLC2200.g:2779:12: ( 'add' | 'nand' )
            int alt3=2;
    ...
    public final void mRULE_IOP_IMM() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2781:14: ( 'addi' )
            // InternalLC2200.g:2781:16: 'addi'
            {
            match("addi"); 
    ...
    public final void mRULE_IOP_OFFSET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2783:17: ( ( 'lw' | 'sw' ) )
            // InternalLC2200.g:2783:19: ( 'lw' | 'sw' )
            {
            // InternalLC2200.g:2783:19: ( 'lw' | 'sw' )
            int alt4=2;
    ...
    public final void mRULE_IOP_LABEL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2785:16: ( 'beq' )
            // InternalLC2200.g:2785:18: 'beq'
            {
            match("beq"); 
    ...
    public final void mRULE_LPAREN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2787:13: ( '(' )
            // InternalLC2200.g:2787:15: '('
            {
            match('('); 
    ...
    public final void mRULE_RPAREN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2789:13: ( ')' )
            // InternalLC2200.g:2789:15: ')'
            {
            match(')'); 
    ...
    public final void mRULE_COMMA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2791:12: ( ',' )
            // InternalLC2200.g:2791:14: ','
            {
            match(','); 
    ...
    public final void mRULE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2793:14: ( '!' (~ ( ( '\\n' | '\\r' ) ) )* )
            // InternalLC2200.g:2793:16: '!' (~ ( ( '\\n' | '\\r' ) ) )*
            {
            match('!'); 
            // InternalLC2200.g:2793:20: (~ ( ( '\\n' | '\\r' ) ) )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_NEWLINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2795:14: ( ( ' ' )* ( '\\r' )? '\\n' )
            // InternalLC2200.g:2795:16: ( ' ' )* ( '\\r' )? '\\n'
            {
            // InternalLC2200.g:2795:16: ( ' ' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_REG() throws RecognitionException {
        try {
            int _type = RULE_REG;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2797:10: ( ( '$zero' | '$at' | '$v0' | '$a0' | '$a1' | '$a2' | '$t0' | '$t1' | '$t2' | '$s0' | '$s1' | '$s2' | '$k0' | '$sp' | '$fp' | '$ra' ) )
            // InternalLC2200.g:2797:12: ( '$zero' | '$at' | '$v0' | '$a0' | '$a1' | '$a2' | '$t0' | '$t1' | '$t2' | '$s0' | '$s1' | '$s2' | '$k0' | '$sp' | '$fp' | '$ra' )
            {
            // InternalLC2200.g:2797:12: ( '$zero' | '$at' | '$v0' | '$a0' | '$a1' | '$a2' | '$t0' | '$t1' | '$t2' | '$s0' | '$s1' | '$s2' | '$k0' | '$sp' | '$fp' | '$ra' )
            int alt8=16;
    ...
    public final void mRULE_IMMEDIATE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2799:16: ( ( '0x' ( '0' .. '9' | ( 'a' | 'b' | 'c' | 'd' | 'e' | 'f' ) )+ | ( '-' )? RULE_INT ) )
            // InternalLC2200.g:2799:18: ( '0x' ( '0' .. '9' | ( 'a' | 'b' | 'c' | 'd' | 'e' | 'f' ) )+ | ( '-' )? RULE_INT )
            {
            // InternalLC2200.g:2799:18: ( '0x' ( '0' .. '9' | ( 'a' | 'b' | 'c' | 'd' | 'e' | 'f' ) )+ | ( '-' )? RULE_INT )
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalLC2200.g:2799:19: '0x' ( '0' .. '9' | ( 'a' | 'b' | 'c' | 'd' | 'e' | 'f' ) )+
                    {
                    match("0x"); 

                    // InternalLC2200.g:2799:24: ( '0' .. '9' | ( 'a' | 'b' | 'c' | 'd' | 'e' | 'f' ) )+
                    int cnt9=0;
                    loop9:
                    do {
                        int alt9=2;
                    ...
                    break;
                case 2 :
                    // InternalLC2200.g:2799:62: ( '-' )? RULE_INT
                    {
                    // InternalLC2200.g:2799:62: ( '-' )?
                    int alt10=2;
    ...
    public final void mRULE_LABEL_IMM() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2801:16: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalLC2200.g:2801:18: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // InternalLC2200.g:2801:42: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_LABEL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2803:12: ( RULE_LABEL_IMM ':' )
            // InternalLC2200.g:2803:14: RULE_LABEL_IMM ':'
            {
            mRULE_LABEL_IMM(); 
            match(':'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2805:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalLC2200.g:2805:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalLC2200.g:2805:11: ( '^' )?
            int alt13=2;
            ...
            // InternalLC2200.g:2805:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalLC2200.g:2807:19: ( ( '0' .. '9' )+ )
            // InternalLC2200.g:2807:21: ( '0' .. '9' )+
            {
            // InternalLC2200.g:2807:21: ( '0' .. '9' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2809:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalLC2200.g:2809:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalLC2200.g:2809:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // InternalLC2200.g:2809:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalLC2200.g:2809:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop16:
                    do {
                        int alt16=3;
                    ...
                    break;
                case 2 :
                    // InternalLC2200.g:2809:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalLC2200.g:2809:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop17:
                    do {
                        int alt17=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2811:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalLC2200.g:2811:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalLC2200.g:2811:24: ( options {greedy=false; } : . )*
            loop19:
            do {
                int alt19=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2813:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalLC2200.g:2813:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalLC2200.g:2813:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop20:
            do {
                int alt20=2;
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2815:16: ( . )
            // InternalLC2200.g:2815:18: .
            {
            matchAny(); 
    ...
    class DFA8 extends DFA {
        ...
        public String getDescription() {
            return "2797:12: ( '$zero' | '$at' | '$v0' | '$a0' | '$a1' | '$a2' | '$t0' | '$t1' | '$t2' | '$s0' | '$s1' | '$s2' | '$k0' | '$sp' | '$fp' | '$ra' )";
        }
    }
    ...
    static final String[] DFA23_transitionS = {
            "\11\35\1\21\1\23\2\35\1\22\22\35\1\1\1\20\1\32\1\35\1\24\2\35\1\33\1\15\1\16\2\35\1\17\1\26\1\3\1\34\1\25\11\27\7\35\32\30\3\35\1\31\1\30\1\35\1\12\1\14\1\30\1\6\1\5\2\30\1\4\1\30\1\11\1\30\1\2\1\30\1\10\3\30\1\7\1\13\7\30\uff85\35",
            "\1\40\2\uffff\1\40\22\uffff\1\37",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    ...
                    case 2 : 
                        ...
                        else if ( ((LA23_0>='\u0000' && LA23_0<='\b')||(LA23_0>='\u000B' && LA23_0<='\f')||(LA23_0>='\u000E' && LA23_0<='\u001F')||LA23_0=='#'||(LA23_0>='%' && LA23_0<='&')||(LA23_0>='*' && LA23_0<='+')||(LA23_0>=':' && LA23_0<='@')||(LA23_0>='[' && LA23_0<=']')||LA23_0=='`'||(LA23_0>='{' && LA23_0<='\uFFFF')) ) {s = 29;}
