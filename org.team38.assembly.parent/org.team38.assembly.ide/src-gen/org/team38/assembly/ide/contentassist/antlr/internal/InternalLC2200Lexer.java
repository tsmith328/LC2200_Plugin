...
public class InternalLC2200Lexer extends Lexer {
    ...
    public final void mRULE_OOP() throws RecognitionException {
        try {
            int _type = RULE_OOP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2731:10: ( ( 'halt' | 'ei' | 'di' | 'reti' | 'bono' ) )
            // InternalLC2200.g:2731:12: ( 'halt' | 'ei' | 'di' | 'reti' | 'bono' )
            {
            // InternalLC2200.g:2731:12: ( 'halt' | 'ei' | 'di' | 'reti' | 'bono' )
            int alt2=5;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_JOP() throws RecognitionException {
        try {
            int _type = RULE_JOP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2735:10: ( ( 'jalr' | 'bonj' ) )
            // InternalLC2200.g:2735:12: ( 'jalr' | 'bonj' )
            {
            // InternalLC2200.g:2735:12: ( 'jalr' | 'bonj' )
            int alt3=2;
    ...
    public final void mRULE_ROP() throws RecognitionException {
        try {
            int _type = RULE_ROP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2737:10: ( ( 'add' | 'nand' | 'bonr' ) )
            // InternalLC2200.g:2737:12: ( 'add' | 'nand' | 'bonr' )
            {
            // InternalLC2200.g:2737:12: ( 'add' | 'nand' | 'bonr' )
            int alt4=3;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_IOP_OFFSET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2741:17: ( ( 'lw' | 'sw' | 'boni' ) )
            // InternalLC2200.g:2741:19: ( 'lw' | 'sw' | 'boni' )
            {
            // InternalLC2200.g:2741:19: ( 'lw' | 'sw' | 'boni' )
            int alt5=3;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_NEWLINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLC2200.g:2753:14: ( ( ' ' )* ( '\\r' )? '\\n' )
            // InternalLC2200.g:2753:16: ( ' ' )* ( '\\r' )? '\\n'
            {
            // InternalLC2200.g:2753:16: ( ' ' )*
            loop7:
            do {
                int alt7=2;
